...
?>
    <div class="row mt-3">
        ...
        <div class="col-sm-6 col-lg-3">
            <a href="http://localhost/cms-php/category" class="text-decoration-none">
        ...
        <div class="col-sm-6 col-lg-3">
            <a href="http://localhost/cms-php/user" class="text-decoration-none">
        ...
        <div class="col-sm-6 col-lg-3">
            <a href="http://localhost/cms-php/article" class="text-decoration-none">
        ...
        <div class="col-sm-6 col-lg-3">
            <a href="http://localhost/cms-php/comment" class="text-decoration-none">
        ...
        <div class="col-4">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-sm">
                    ...
                    <tr>
                        <td><a class="text-primary" href="http://localhost/cms-php/article/show/<?php echo  $article['id'] ?>"><?php echo  $article['id'] ?></a></td>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-sm">
                    ...
                    <?php foreach($lastComments as $comment) {?>
                        ...
                        <tr>
                            <td><a class="text-primary" href="http://localhost/cms-php/comment/show/<?php echo  $comment['id'] ?>"><?php echo  $comment['id'] ?></a></td>
