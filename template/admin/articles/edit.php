...
?>
    ...
    <section class="row my-3">
        ...
        <section class="col-12">
            ...
            <form method="post" action="http://localhost/cms-php/article/update/<?php echo $id;?>" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <img style="width: 100px;" src="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/cms-php/' . $article['image'];?>" alt="">  
