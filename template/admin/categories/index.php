    ...
    foreach ($categories as $category) { ?>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a role="button" href="http://localhost/cms-php/category/edit/<?php echo $category['id']; ?>" 

                    class="btn btn-sm btn-info my-0 mx-1 text-white">update</a>
         

                    <a role="button" href="http://localhost/cms-php/category/delete/<?php echo $category['id']; ?>"
